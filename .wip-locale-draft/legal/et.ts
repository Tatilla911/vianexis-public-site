...
export const legalEt: LegalContent = {
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Juht ja ettevõte vastutavad reisi, dokumentide, __KAITSE_13__ ja tollinõuete täitmise eest. Rakendus toetab dokumentatsiooni – ei asenda õigusnõustamist, ADR eksperte ega ametiasutusi.",
      },
      {
        title: "Kättesaadavus",
  ...
  disclaimersPage: {
    ...
    items: [
      ...
      {
        id: "ai-ocr",
        title: "AI, __KAITSE_14__ ja tõlge",
