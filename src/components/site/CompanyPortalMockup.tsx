      ...
      >
        ...
        <div className="bg-navy-1000 p-4">
          ...
          <div className="mb-3 flex flex-wrap items-start justify-between gap-2">
            ...
            <span className="rounded-full border border-gold-core/40 bg-gold-core/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wide text-gold-core">
              {portal.roleLabel}
            </span>
          </div>
              ...
              {rows.map((row, idx) => {
                ...
                return (
                  <div
                    key={`${row[0]}-${idx}`}
                    className={cn(
                      "grid gap-1 border-l-2 px-3 py-2.5 text-xs text-white sm:grid-cols-4 sm:gap-2",
                      isActiveTrip
          ...
          <div className="mt-3 grid gap-2.5 sm:grid-cols-2">
            <div className="rounded-md border border-warning/35 bg-warning/[0.06] p-3">
              <p className="text-[10px] uppercase tracking-wide text-gold-light">
                {portal.alertLabel}
              </p>
            ...
            <div className="rounded-md border border-cyan-glow/30 bg-cyan-glow/[0.06] p-3">
              <p className="text-[10px] uppercase tracking-wide text-cyan-glow">
                {portal.auditLabel}
              </p>
              <p className="mt-1 text-xs font-medium text-white">
                {portal.auditValue}
