...
function WorldPanel() {
  return (
    <g>
      ...
      {/* Cyan network filaments over land */}
      <g
        stroke="#00BFFF"
        strokeOpacity="0.55"
        strokeWidth="1.1"
        ...
        strokeLinecap="round"
      >
        <path d="M90 150 C130 130, 170 140, 200 160" />
        <path d="M210 140 C250 130, 300 140, 360 160" />
        <path d="M230 210 C270 230, 310 250, 350 270" />
        <path d="M140 250 C180 270, 220 280, 250 300" />
        <path d="M250 160 C270 190, 280 220, 270 250" />
      </g>
    </g>
  );
}
