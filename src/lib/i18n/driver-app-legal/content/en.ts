...
import { dataSafetySectionsEn } from "./data-safety-sections-en";
...
export const driverAppLegalEn: DriverAppLegalBundle = {
  ...
  dataSafety: {
    ...
    metaDescription:
      "Plain-language summary of ViaNexis Driver data handling: location, camera, push, OCR, deletion and providers. Not the Google Play Data safety form.",
    intro:
    ...
    tableHeaders: {
      ...
      collected: "What we may process",
      requirement: "Required / optional",
      origin: "Source",
      purpose: "Purpose",
      sharing: "Recipients / providers",
    },
    rows: [
      {
        category: "Account data",
        collected: "Name, email, phone, company affiliation; local PIN salted hash; auth tokens",
        requirement: "Required for account use",
        origin: "User / system",
        purpose: "Authentication, account management",
        sharing: "Carrier company; hosting. Not sold.",
      },
      {
        category: "Location data",
        collected: "GPS when permitted (when-in-use; no background location permission in the manifest)",
        requirement: "Optional, permission-based",
        origin: "Device sensors",
        purpose: "Map, trip location capture, some evidence/alert features",
        sharing: "Depending on feature: backend / company; map stream may stay local",
      },
      {
        category: "Camera, photos, videos",
        collected: "Trip / document / damage media",
        requirement: "Feature-dependent, typically optional",
        origin: "User",
        purpose: "Documentation, evidence",
        sharing: "Carrier company; storage provider on upload",
      },
      {
        category: "Documents and signatures",
        collected: "Transport documents, signature strokes, timestamp, optional location",
        requirement: "Feature / trip dependent",
        origin: "User / company",
        purpose: "Evidence, operational documentation",
        sharing: "Carrier company; authority where legally required",
      },
      {
        category: "Messages",
        collected: "Operational messages and attachments",
        requirement: "Optional",
        origin: "User",
        purpose: "Communication, documentation",
        sharing: "Carrier company; translation path if translation is enabled",
      },
      {
        category: "OCR / speech (if used)",
        collected: "OCR text; speech / audio input",
        requirement: "Optional",
        origin: "Device / OS / upload",
        purpose: "Input assistance",
        sharing: "OCR typically on-device; speech/translation depends on path",
      },
      {
        category: "Push token",
        collected: "FCM token, device-registration meta",
        requirement: "Optional, when push is active",
        origin: "Automatic",
        purpose: "Operational notifications",
        sharing: "FCM / backend (to be assessed as a processor)",
      },
      {
        category: "Device and security meta",
        collected: "Platform, language, timezone; security events",
        requirement: "As needed",
        origin: "Automatic",
        purpose: "Operation, security",
        sharing: "Hosting; no separate analytics/Crashlytics SDK per current audit",
      },
    ],
    sections: dataSafetySectionsEn,
