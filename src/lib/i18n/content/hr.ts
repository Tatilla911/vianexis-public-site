...
export const contentHr: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis je trenutno dostupan kroz pilot program s odabranim prijevoznicima i vozačima.",
      "Pristup se aktivira nakon individualnog razgovora i odobrenja.",
      "Nema preuzimanja iz javne trgovine aplikacija.",
    ],
    disclaimer:
      "ViaNexis ne tvrdi da je sustav službeno prihvaćen ili certificiran u svakoj zemlji.",
  },
  ...
  applicationForms: {
    common: {
      privacy: "Prihvaćam politiku privatnosti i pristajem na obradu podataka. *",
      submit: "Pošaljite prijavu",
      submitting: "Submitting…",
      intakeDisabled: "U pripremi su online prijave. Kontaktirajte support@vianexis.eu ili pokušajte ponovno kasnije.",
      successTitle: "Prijava primljena",
      successBody: "Hvala. Vaša je prijava u pregledu. Pristup nije dopušten dok ga ViaNexis administrator ne odobri.",
      newSubmission: "Nova aplikacija",
      referenceLabel: "Referenca aplikacije",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Kontaktirat ćemo vas nakon pregleda. Zadržite svoju referencu aplikacije za podršku.",
      ...
      errors: {
        ...
        privacy: "Potrebno je prihvaćanje privatnosti.",
        submitFailed: "Prijavu nije bilo moguće poslati. Pokušajte ponovno kasnije.",
        duplicate: "Prijava za ovu tvrtku ili e-mail je već u tijeku.",
        duplicateWithRef: "Prijava za ovu tvrtku ili e-poštu je već u tijeku (referenca: {reference}).",
        captchaRequired: "Za nastavak dovršite sigurnosnu provjeru.",
        captchaInvalid: "Sigurnosna provjera je istekla ili nije uspjela. Pokušajte ponovno.",
        spam: "Predaja je blokirana.",
