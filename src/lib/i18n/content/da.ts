...
export const contentDa: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis er i øjeblikket tilgængelig gennem et pilotprogram med udvalgte transportører og chauffører.",
      "Adgang aktiveres efter individuel diskussion og godkendelse.",
      "Ingen offentlig app-store download.",
    ],
    disclaimer:
      "ViaNexis hævder ikke, at systemet er officielt accepteret eller certificeret i alle lande.",
  },

  moduleLabels: {
    goal: "Mål",
    appFoundation: "Nøglefunktioner",
  ...
  home: {
    ...
    contact: {
      ...
      body: "Adgang er i øjeblikket tilgængelig gennem et kontrolleret pilotprogram. Aktivering følger en individuel gennemgang.",
  ...
  applicationForms: {
    common: {
      privacy: "Jeg accepterer privatlivspolitikken og giver samtykke til databehandling. *",
      submit: "Indsend ansøgning",
      submitting: "Submitting…",
      intakeDisabled: "Online ansøgninger er ved at blive udarbejdet. Kontakt support@vianexis.eu eller prøv igen senere.",
      successTitle: "Ansøgning modtaget",
      successBody: "Tak. Din ansøgning er under behandling. Adgang gives ikke, før en ViaNexis-administrator godkender det.",
      newSubmission: "Ny ansøgning",
      referenceLabel: "Ansøgningsreference",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Vi kontakter dig efter gennemgang. Gem din ansøgningsreference for support.",
      captchaHint: "Gennemfør sikkerhedstjekket før indsendelse.",
      supportContact: "Har du brug for hjælp? Kontakt {email}.",
      errors: {
        required: "Dette felt er påkrævet.",
        email: "E-mail er påkrævet.",
        emailInvalid: "Indtast en gyldig e-mailadresse.",
        password: "Adgangskoden skal være på mindst 8 tegn.",
        privacy: "Fortrolighedsaccept er påkrævet.",
        submitFailed: "Ansøgningen kunne ikke sendes. Prøv igen senere.",
        duplicate: "En ansøgning for denne virksomhed eller e-mail er allerede i gang.",
        duplicateWithRef: "En ansøgning for denne virksomhed eller e-mail er allerede i gang (reference: {reference}).",
        captchaRequired: "Gennemfør sikkerhedstjekket for at fortsætte.",
        captchaInvalid: "Sikkerhedstjekket udløb eller mislykkedes. Prøv igen.",
        spam: "Indsendelse blokeret.",
        network: "Netværksfejl. Tjek din forbindelse, og prøv igen.",
      },
    },
    company: { title: "Firmaansøgning", subtitle: "Ansøg om adgang til ViaNexis virksomhedsplatform.", companyName: "Firmanavn *", country: "Country *", vatNumber: "VAT / tax ID", contactName: "Navn på kontakt *", contactEmail: "Kontakt email *", contactPhone: "Phone *", fleetSize: "Fleet size", moduleInterests: "Moduler af interesse", moduleOptions: [{ value: "driver_app", label: "Driver app" },{ value: "dispatch_portal", label: "Forsendelsesportal" },{ value: "documents", label: "Documents" },{ value: "fleet_workshop", label: "Flåde / værksted" },{ value: "pallet_packaging", label: "Palle / emballage" },{ value: "external_shipper_receiver", label: "Ekstern afsender/modtager" }], notes: "Notes" },
    driver: { title: "Driver applikation", subtitle: "Selvregistrering — afventer godkendelse før login.", fullName: "Full name *", email: "Email *", password: "Password *", phone: "Phone", country: "Country", companyNameHint: "Firmanavn (valgfrit)", companyCode: "Invitation / virksomhedskode (valgfrit)", licenseNotes: "Licens / ADR / GKI noter (valgfrit)" },
    partner: { title: "Partner interesse", subtitle: "Forespørgsel fra afsender, modtager, lager eller toldpartner.", companyName: "Firmanavn *", role: "Role *", roleOptions: [{ value: "shipper", label: "Shipper" },{ value: "receiver", label: "Receiver" },{ value: "warehouse", label: "Warehouse" },{ value: "customs_broker", label: "Toldmægler" },{ value: "other_partner", label: "Anden partner" }], contactName: "Navn på kontakt *", email: "Email *", phone: "Phone", notes: "Notes" },
  },
  authorityEfti: {
    cards: [
      {
