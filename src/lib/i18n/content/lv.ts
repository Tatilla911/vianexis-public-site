...
export const contentLv: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis pašlaik ir pieejams, izmantojot izmēģinājuma programmu ar atlasītiem pārvadātājiem un draiveriem.",
      "Piekļuve tiek aktivizēta pēc individuālas apspriešanas un apstiprināšanas.",
      "Nav publiskas lietotņu veikala lejupielādes.",
    ],
    disclaimer:
      "ViaNexis neapgalvo, ka sistēma ir oficiāli pieņemta vai sertificēta visās valstīs.",
  },
  ...
  home: {
    ...
    contact: {
      ...
      body: "Piekļuve pašlaik ir pieejama, izmantojot kontrolētu izmēģinājuma programmu. Aktivizēšana notiek pēc individuālas pārskatīšanas.",
  ...
  applicationForms: {
    common: {
      privacy: "Es piekrītu privātuma politikai un piekrītu datu apstrādei. *",
      submit: "Iesniegt pieteikumu",
      submitting: "Submitting…",
      intakeDisabled: "Tiek gatavoti tiešsaistes pieteikumi. Sazinieties ar support@vianexis.eu vai vēlāk mēģiniet vēlreiz.",
      successTitle: "Pieteikums saņemts",
      successBody: "Paldies. Jūsu pieteikums tiek izskatīts. Piekļuve netiek piešķirta, kamēr ViaNexis administrators to nav apstiprinājis.",
      newSubmission: "Jauna aplikācija",
      referenceLabel: "Pieteikuma atsauce",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Mēs ar jums sazināsimies pēc izskatīšanas. Saglabājiet savu pieteikuma atsauci atbalsta saņemšanai.",
      captchaHint: "Pirms iesniegšanas pabeidziet drošības pārbaudi.",
      supportContact: "Nepieciešama palīdzība? Sazinieties ar {email}.",
      errors: {
        required: "Šis lauks ir obligāts.",
        email: "Nepieciešams e-pasts.",
        emailInvalid: "Ievadiet derīgu e-pasta adresi.",
        password: "Parolei ir jābūt vismaz 8 rakstzīmēm.",
        privacy: "Nepieciešama privātuma piekrišana.",
        submitFailed: "Pieteikumu nevarēja nosūtīt. Vēlāk mēģiniet vēlreiz.",
        duplicate: "Pieteikšanās šim uzņēmumam vai e-pastam jau notiek.",
        duplicateWithRef: "Pieteikšanās šim uzņēmumam vai e-pastam jau notiek (atsauce: {reference}).",
        captchaRequired: "Lai turpinātu, pabeidziet drošības pārbaudi.",
        captchaInvalid: "Drošības pārbaude ir beidzies vai neizdevās. Mēģiniet vēlreiz.",
        spam: "Iesniegšana bloķēta.",
