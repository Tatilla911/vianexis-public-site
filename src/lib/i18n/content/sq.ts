...
export const contentSq: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis aktualisht është në dispozicion përmes një programi pilot me operatorë dhe drejtues të zgjedhur.",
      "Qasja aktivizohet pas diskutimit dhe miratimit individual.",
      "Asnjë shkarkim publik në dyqanin e aplikacioneve.",
    ],
    disclaimer:
      "ViaNexis nuk pretendon se sistemi është i pranuar ose i certifikuar zyrtarisht në çdo vend.",
  },
  ...
  home: {
    ...
    contact: {
      ...
      body: "Aksesi është aktualisht i disponueshëm përmes një programi pilot të kontrolluar. Aktivizimi pason një rishikim individual.",
  ...
  applicationForms: {
    common: {
      privacy: "Unë pranoj politikën e privatësisë dhe pranoj përpunimin e të dhënave. *",
      submit: "Paraqisni aplikacionin",
      submitting: "Submitting…",
      intakeDisabled: "Aplikimet online janë duke u përgatitur. Kontaktoni support@vianexis.eu ose provoni sërish më vonë.",
      successTitle: "Aplikimi u mor",
      successBody: "faleminderit. Aplikacioni juaj është në shqyrtim. Qasja nuk jepet derisa një administrator i ViaNexis ta aprovojë atë.",
      newSubmission: "Aplikim i ri",
      referenceLabel: "Referenca e aplikimit",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Ne do t'ju kontaktojmë pas shqyrtimit. Mbani referencën e aplikacionit tuaj për mbështetje.",
      captchaHint: "Përfundoni kontrollin e sigurisë përpara se ta dorëzoni.",
      supportContact: "Keni nevojë për ndihmë? Kontaktoni {email}.",
      errors: {
        required: "Kjo fushë është e nevojshme.",
        email: "Kërkohet email.",
        emailInvalid: "Fut një adresë të vlefshme emaili.",
        password: "Fjalëkalimi duhet të jetë së paku 8 karaktere.",
        privacy: "Kërkohet pranimi i privatësisë.",
        submitFailed: "Aplikacioni nuk mund të dërgohej. Provo sërish më vonë.",
        duplicate: "Një aplikim për këtë kompani ose email është tashmë në proces.",
        duplicateWithRef: "Një aplikim për këtë kompani ose email është tashmë në proces (referenca: {reference}).",
        captchaRequired: "Përfundoni kontrollin e sigurisë për të vazhduar.",
        captchaInvalid: "Kontrolli i sigurisë skadoi ose dështoi. Provo sërish.",
        spam: "Dorëzimi u bllokua.",
