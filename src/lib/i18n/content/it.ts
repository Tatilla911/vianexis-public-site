...
export const contentIt: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis è attualmente disponibile attraverso un programma pilota con vettori e autisti selezionati.",
      "L'accesso viene attivato previa discussione e approvazione individuale.",
      "Nessun download dall'app store pubblico.",
    ],
    disclaimer:
      "ViaNexis non afferma che il sistema sia ufficialmente accettato o certificato in ogni paese.",
  },
  ...
  home: {
    ...
    contact: {
      ...
      body: "L’accesso è attualmente disponibile attraverso un programma pilota controllato. L'attivazione segue una revisione individuale.",
  ...
  applicationForms: {
    common: {
      privacy: "Accetto l'informativa sulla privacy e acconsento al trattamento dei dati. *",
      submit: "Invia domanda",
      submitting: "Submitting…",
      intakeDisabled: "Sono in preparazione le candidature on-line. Contatta support@vianexis.eu o riprova più tardi.",
      successTitle: "Domanda ricevuta",
      successBody: "Grazie. La tua richiesta è in fase di revisione. L'accesso non viene concesso finché un amministratore ViaNexis non lo approva.",
      newSubmission: "Nuova applicazione",
      referenceLabel: "Riferimento dell'applicazione",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Ti contatteremo dopo la revisione. Conserva il riferimento della tua domanda per ricevere supporto.",
      captchaHint: "Completa il controllo di sicurezza prima di inviare.",
      supportContact: "Serve aiuto? Contatta {email}.",
      errors: {
        required: "Questo campo è obbligatorio.",
        email: "L'e-mail è obbligatoria.",
        emailInvalid: "Inserisci un indirizzo email valido.",
        password: "La password deve contenere almeno 8 caratteri.",
        privacy: "E' richiesta l'accettazione della privacy.",
        submitFailed: "Impossibile inviare la domanda. Riprova più tardi.",
        duplicate: "Una richiesta per questa azienda o e-mail è già in corso.",
        duplicateWithRef: "Una candidatura per questa azienda o email è già in corso (riferimento: {reference}).",
        captchaRequired: "Completa il controllo di sicurezza per continuare.",
        captchaInvalid: "Il controllo di sicurezza è scaduto o non è riuscito. Riprova.",
        spam: "Invio bloccato.",
        network: "Errore di rete. Controlla la connessione e riprova.",
      },
    },
    company: { title: "Applicazione aziendale", subtitle: "Richiedi l'accesso alla piattaforma aziendale ViaNexis.", companyName: "Nome dell'azienda *", country: "Country *", vatNumber: "VAT / tax ID", contactName: "Nome del contatto *", contactEmail: "E-mail di contatto *", contactPhone: "Phone *", fleetSize: "Fleet size", moduleInterests: "Moduli di interesse", moduleOptions: [{ value: "driver_app", label: "Driver app" },{ value: "dispatch_portal", label: "Portale di spedizione" },{ value: "documents", label: "Documents" },{ value: "fleet_workshop", label: "Flotta/officina" },{ value: "pallet_packaging", label: "Pallet/imballaggio" },{ value: "external_shipper_receiver", label: "Spedizioniere/destinatario esterno" }], notes: "Notes" },
    driver: { title: "Applicazione del conducente", subtitle: "Autoregistrazione: in attesa di approvazione prima dell'accesso.", fullName: "Full name *", email: "Email *", password: "Password *", phone: "Phone", country: "Country", companyNameHint: "Nome dell'azienda (facoltativo)", companyCode: "Codice invito/azienda (facoltativo)", licenseNotes: "Note licenza / ADR / GKI (opzionale)" },
    partner: { title: "Interesse del partner", subtitle: "Richiesta di spedizionieri, destinatari, magazzini o partner doganali.", companyName: "Nome dell'azienda *", role: "Role *", roleOptions: [{ value: "shipper", label: "Shipper" },{ value: "receiver", label: "Receiver" },{ value: "warehouse", label: "Warehouse" },{ value: "customs_broker", label: "Spedizioniere doganale" },{ value: "other_partner", label: "Altro socio" }], contactName: "Nome del contatto *", email: "Email *", phone: "Phone", notes: "Notes" },
  },
  authorityEfti: {
    cards: [
      {
