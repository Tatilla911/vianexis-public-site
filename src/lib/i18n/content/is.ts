...
export const contentIs: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis er nú fáanlegt í gegnum tilraunaáætlun með völdum flutningsaðilum og bílstjórum.",
      "Aðgangur er virkjaður eftir einstaka umræðu og samþykki.",
      "Ekkert opinber app-verslun niðurhal.",
    ],
    disclaimer:
      "ViaNexis heldur því ekki fram að kerfið sé opinberlega samþykkt eða vottað í hverju landi.",
  },
  ...
  home: {
    ...
    contact: {
      ...
      body: "Aðgangur er nú í boði í gegnum stýrt tilraunaverkefni. Virkjun fylgir einstaklingsbundinni skoðun.",
  ...
  applicationForms: {
    common: {
      privacy: "Ég samþykki persónuverndarstefnuna og samþykki gagnavinnslu. *",
      submit: "Sendu umsókn",
      submitting: "Submitting…",
      intakeDisabled: "Verið er að undirbúa umsóknir á netinu. Hafðu samband við support@vianexis.eu eða reyndu aftur síðar.",
      successTitle: "Umsókn móttekin",
      successBody: "Þakka þér fyrir. Umsókn þín er í skoðun. Aðgangur er ekki veittur fyrr en ViaNexis stjórnandi samþykkir það.",
      newSubmission: "Ný umsókn",
      referenceLabel: "Umsóknartilvísun",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Við munum hafa samband við þig eftir skoðun. Geymdu umsóknartilvísun þína til stuðnings.",
      captchaHint: "Ljúktu við öryggisathugunina áður en þú sendir inn.",
      supportContact: "Þarftu aðstoð? Hafðu samband við {email}.",
      errors: {
        required: "Þessi reitur er nauðsynlegur.",
        email: "Tölvupóstur er nauðsynlegur.",
        emailInvalid: "Sláðu inn gilt netfang.",
        password: "Lykilorð verður að vera að minnsta kosti 8 stafir.",
        privacy: "Persónuverndarsamþykki er krafist.",
        submitFailed: "Ekki tókst að senda umsókn. Reyndu aftur síðar.",
        duplicate: "Umsókn fyrir þetta fyrirtæki eða tölvupóst er þegar í vinnslu.",
        duplicateWithRef: "Umsókn fyrir þetta fyrirtæki eða netfang er þegar í vinnslu (tilvísun: {reference}).",
        captchaRequired: "Ljúktu við öryggisathugunina til að halda áfram.",
        captchaInvalid: "Öryggisskoðun rann út eða mistókst. Reyndu aftur.",
        spam: "Lokað fyrir uppgjöf.",
