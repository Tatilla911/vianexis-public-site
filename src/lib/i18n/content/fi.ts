...
export const contentFi: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis on tällä hetkellä saatavilla pilottiohjelman kautta valittujen operaattorien ja kuljettajien kanssa.",
      "Pääsy aktivoidaan henkilökohtaisen keskustelun ja hyväksynnän jälkeen.",
      "Ei julkista sovelluskaupan latausta.",
    ],
    disclaimer:
      "ViaNexis ei väitä, että järjestelmä olisi virallisesti hyväksytty tai sertifioitu kaikissa maissa.",
  },
  ...
  platformModules: [
    ...
    },
    {
      ...
      appFoundation: "ADR-tiedot, YK-numerohaku, tunnelikoodin apuohjelma, matkoihin linkitetty raja-/tulli-metatiedot.",
      backendDependency: "ADR-tietokannan päivitykset, maakohtaiset sääntöjen metatiedot, rajatarkastuspisteiden tiedot.",
  ...
  applicationForms: {
    common: {
      privacy: "Hyväksyn tietosuojaselosteen ja suostun tietojen käsittelyyn. *",
      submit: "Lähetä hakemus",
      submitting: "Submitting…",
      intakeDisabled: "Verkkohakemuksia valmistellaan. Ota yhteyttä support@vianexis.eu tai yritä myöhemmin uudelleen.",
      successTitle: "Hakemus vastaanotettu",
      successBody: "Kiitos. Hakemuksesi on tarkistettavana. Käyttöoikeutta ei myönnetä ennen kuin ViaNexis-järjestelmänvalvoja hyväksyy sen.",
      newSubmission: "Uusi sovellus",
      referenceLabel: "Sovelluksen viite",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Otamme sinuun yhteyttä tarkistuksen jälkeen. Säilytä hakemuksesi viite tukea varten.",
      captchaHint: "Suorita turvatarkastus ennen lähettämistä.",
      supportContact: "Tarvitsetko apua? Ota yhteyttä {email}.",
      errors: {
        required: "Tämä kenttä on pakollinen.",
        email: "Sähköposti vaaditaan.",
        emailInvalid: "Anna kelvollinen sähköpostiosoite.",
        password: "Salasanassa on oltava vähintään 8 merkkiä.",
        privacy: "Yksityisyyden hyväksyminen vaaditaan.",
        submitFailed: "Hakemusta ei voitu lähettää. Yritä myöhemmin uudelleen.",
        duplicate: "Tämän yrityksen tai sähköpostin haku on jo käynnissä.",
        duplicateWithRef: "Tälle yritykselle tai sähköpostille on jo käynnissä oleva hakemus (viite: {reference}).",
        captchaRequired: "Suorita turvatarkastus jatkaaksesi.",
        captchaInvalid: "Turvatarkistus vanhentunut tai epäonnistunut. Yritä uudelleen.",
        spam: "Lähetys estetty.",
