...
export const contentCs: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis je v současné době k dispozici prostřednictvím pilotního programu s vybranými dopravci a řidiči.",
      "Přístup je aktivován po individuálním projednání a schválení.",
      "Žádné stahování z veřejného obchodu s aplikacemi.",
    ],
    disclaimer:
      "ViaNexis netvrdí, že systém je oficiálně akceptován nebo certifikován v každé zemi.",
  },
  ...
  platformModules: [
    ...
    },
    {
      ...
      disclaimer: "Cílová obrazovka se otevře po PIN. Notifications netvrdí, že každá událost dorazí okamžitě.",
    },
    {
      id: "pallet-packaging",
  ...
  home: {
    ...
    contact: {
      ...
      body: "Přístup je v současné době dostupný prostřednictvím řízeného pilotního programu. Aktivace následuje po individuální kontrole.",
  ...
  applicationForms: {
    common: {
      privacy: "Přijímám zásady ochrany osobních údajů a souhlasím se zpracováním údajů. *",
      submit: "Odešlete přihlášku",
      submitting: "Submitting…",
      intakeDisabled: "Online přihlášky se připravují. Kontaktujte support@vianexis.eu nebo to zkuste znovu později.",
      successTitle: "Přihláška přijata",
      successBody: "Děkuju. Probíhá kontrola vaší žádosti. Přístup není udělen, dokud jej neschválí správce ViaNexis.",
      newSubmission: "Nová aplikace",
      referenceLabel: "Odkaz na aplikaci",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Po kontrole vás budeme kontaktovat. Uschovejte si referenci aplikace pro podporu.",
      captchaHint: "Před odesláním dokončete bezpečnostní kontrolu.",
      supportContact: "Potřebujete pomoc? Kontaktujte {email}.",
      errors: {
        required: "Toto pole je povinné.",
        email: "E-mail je povinný.",
        emailInvalid: "Zadejte platnou e-mailovou adresu.",
        password: "Heslo musí mít alespoň 8 znaků.",
        privacy: "Je vyžadován souhlas s ochranou soukromí.",
        submitFailed: "Přihlášku se nepodařilo odeslat. Zkuste to znovu později.",
        duplicate: "Žádost pro tuto společnost nebo e-mail již probíhá.",
        duplicateWithRef: "Žádost pro tuto společnost nebo e-mail již probíhá (reference: {reference}).",
        captchaRequired: "Chcete-li pokračovat, dokončete kontrolu zabezpečení.",
        captchaInvalid: "Platnost bezpečnostní kontroly vypršela nebo se nezdařila. Zkuste to znovu.",
        spam: "Odeslání zablokováno.",
        network: "Chyba sítě. Zkontrolujte připojení a zkuste to znovu.",
      },
    },
    company: { title: "Firemní aplikace", subtitle: "Požádejte o přístup k firemní platformě ViaNexis.", companyName: "Název společnosti *", country: "Country *", vatNumber: "VAT / tax ID", contactName: "Kontaktní jméno *", contactEmail: "Kontaktní email *", contactPhone: "Phone *", fleetSize: "Fleet size", moduleInterests: "Zájmové moduly", moduleOptions: [{ value: "driver_app", label: "Driver app" },{ value: "dispatch_portal", label: "Expediční portál" },{ value: "documents", label: "Documents" },{ value: "fleet_workshop", label: "Vozový park / dílna" },{ value: "pallet_packaging", label: "Paleta / obal" },{ value: "external_shipper_receiver", label: "Externí odesílatel/příjemce" }], notes: "Notes" },
    driver: { title: "Aplikace ovladače", subtitle: "Samoregistrace — čeká na schválení před přihlášením.", fullName: "Full name *", email: "Email *", password: "Password *", phone: "Phone", country: "Country", companyNameHint: "Název společnosti (volitelné)", companyCode: "Pozvánka / kód společnosti (volitelné)", licenseNotes: "Poznámky k licenci / ADR / GKI (volitelné)" },
    partner: { title: "Zájem partnera", subtitle: "Dotaz na odesílatele, příjemce, sklad nebo celního partnera.", companyName: "Název společnosti *", role: "Role *", roleOptions: [{ value: "shipper", label: "Shipper" },{ value: "receiver", label: "Receiver" },{ value: "warehouse", label: "Warehouse" },{ value: "customs_broker", label: "Celní makléř" },{ value: "other_partner", label: "Jiný partner" }], contactName: "Kontaktní jméno *", email: "Email *", phone: "Phone", notes: "Notes" },
  },
  authorityEfti: {
    cards: [
      {
