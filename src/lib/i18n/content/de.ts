...
export const contentDe: SiteContent = {
  ...
  applicationForms: {
    common: {
      ...
      successBody: "Vielen Dank. Ihre Bewerbung wird geprüft. Der Zugriff wird erst nach Genehmigung durch einen ViaNexis-Administrator freigeschaltet — keine automatische Freigabe.",
      newSubmission: "Neue Bewerbung",
      referenceLabel: "Bewerbungsreferenz",
      submittedAtLabel: "Eingereicht am",
      statusLabel: "Status",
      statusUnderReview: "In Prüfung",
      nextStep: "Nach der Prüfung melden wir uns bei Ihnen. Bewahren Sie Ihre Bewerbungsreferenz auf.",
      ...
      errors: {
        ...
        privacy: "Die Datenschutzakzeptanz ist erforderlich.",
        submitFailed: "Die Bewerbung konnte nicht gesendet werden. Versuchen Sie es später erneut.",
        duplicate: "Für dieses Unternehmen oder diese E-Mail liegt bereits eine laufende Bewerbung vor.",
        duplicateWithRef: "Für dieses Unternehmen oder diese E-Mail liegt bereits eine laufende Bewerbung vor (Referenz: {reference}).",
    ...
    company: {
      title: "Firmenbewerbung",
      subtitle: "Beantragen Sie den Zugang zur ViaNexis-Unternehmensplattform.",
      companyName: "Firmenname *",
      country: "Land *",
      vatNumber: "USt-IdNr. / Steuernummer",
      contactName: "Ansprechpartner *",
      contactEmail: "Kontakt-E-Mail *",
      contactPhone: "Telefon *",
      fleetSize: "Fuhrparkgröße",
      moduleInterests: "Interessierende Module",
      moduleOptions: [
        { value: "driver_app", label: "Fahrer-App" },
    ...
    driver: {
      ...
      subtitle: "Selbstregistrierung — Anmeldung erst nach Freigabe möglich.",
      fullName: "Vollständiger Name *",
      email: "E-Mail *",
      password: "Passwort *",
      phone: "Telefon",
      country: "Land",
      companyNameHint: "Firmenname (optional)",
      companyCode: "Einladungs- / Firmencode (optional)",
      licenseNotes: "Führerschein- / ADR- / GKI-Hinweise (optional)",
    },
    partner: {
      title: "Partnerinteresse",
      subtitle: "Anfrage als Versender, Empfänger, Lager oder Zollpartner.",
      companyName: "Firmenname *",
      role: "Rolle *",
      roleOptions: [
        { value: "shipper", label: "Versender" },
        { value: "receiver", label: "Empfänger" },
        { value: "warehouse", label: "Lager" },
        { value: "customs_broker", label: "Zollagent" },
        { value: "other_partner", label: "Anderer Partner" },
      ],
      contactName: "Ansprechpartner *",
      email: "E-Mail *",
      phone: "Telefon",
