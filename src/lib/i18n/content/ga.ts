...
export const contentGa: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "Tá ViaNexis ar fáil faoi láthair trí chlár píolótach le hiompróirí agus tiománaithe roghnaithe.",
      "Cuirtear rochtain i ngníomh tar éis plé aonair agus faomhadh.",
      "Níl aon íoslódáil app store poiblí.",
    ],
    disclaimer:
      "Ní éilíonn ViaNexis go bhfuil an córas glactha nó deimhnithe go hoifigiúil i ngach tír.",
  },
  ...
  home: {
    ...
    contact: {
      ...
      body: "Tá rochtain ar fáil faoi láthair trí chlár píolótach rialaithe. Leanann gníomhachtú athbhreithniú aonair.",
  ...
  applicationForms: {
    common: {
      privacy: "Glacaim leis an bpolasaí príobháideachais agus toilím le próiseáil sonraí. *",
      submit: "Cuir iarratas isteach",
      submitting: "Submitting…",
      intakeDisabled: "Tá iarratais ar líne á n-ullmhú. Déan teagmháil le support@vianexis.eu nó bain triail eile as ar ball.",
      successTitle: "Iarratas faighte",
      successBody: "Go raibh maith agat. Tá d’iarratas faoi athbhreithniú. Ní thugtar rochtain go dtí go gceadaíonn riarthóir ViaNexis í.",
      newSubmission: "Feidhmchlár nua",
      referenceLabel: "Tagairt iarratais",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Déanfaimid teagmháil leat tar éis athbhreithniú. Coinnigh do thagairt iarratais le haghaidh tacaíochta.",
      captchaHint: "Críochnaigh an tseiceáil slándála sula gcuirtear isteach é.",
      supportContact: "Cabhair uait? Déan teagmháil le {email}.",
      errors: {
        required: "Tá an réimse seo ag teastáil.",
        email: "Tá ríomhphost ag teastáil.",
        emailInvalid: "Cuir isteach seoladh ríomhphoist bailí.",
        password: "Caithfidh pasfhocal a bheith 8 gcarachtar ar a laghad.",
        privacy: "Tá glacadh príobháideachta ag teastáil.",
        submitFailed: "Níorbh fhéidir an t-iarratas a sheoladh. Bain triail eile as ar ball.",
        duplicate: "Tá iarratas don chuideachta nó don ríomhphost seo idir lámha cheana féin.",
        duplicateWithRef: "Tá feidhmchlár don chuideachta nó don ríomhphost seo ar siúl cheana féin (tagairt: {reference}).",
        captchaRequired: "Críochnaigh an seiceáil slándála chun leanúint ar aghaidh.",
        captchaInvalid: "Chuaigh seiceáil slándála in éag nó theip air. Bain triail eile as.",
        spam: "Cuireadh bac ar an aighneacht.",
