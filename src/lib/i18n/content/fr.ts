...
export const contentFr: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis est actuellement disponible via un programme pilote avec des transporteurs et des chauffeurs sélectionnés.",
      "L'accès est activé après discussion et approbation individuelles.",
      "Aucun téléchargement public sur l'App Store.",
    ],
    disclaimer:
      "ViaNexis ne prétend pas que le système est officiellement accepté ou certifié dans tous les pays.",
  },
  ...
  platformModules: [
    ...
    },
    {
      ...
      backendDependency: "Les fonctionnalités de notification peuvent être activées dans le cadre du programme pilote.",
  ...
  home: {
    ...
    contact: {
      ...
      body: "L'accès est actuellement disponible via un programme pilote contrôlé. L'activation fait suite à un examen individuel.",
  ...
  applicationForms: {
    common: {
      privacy: "J'accepte la politique de confidentialité et consens au traitement des données. *",
      submit: "Soumettre la candidature",
      submitting: "Submitting…",
      intakeDisabled: "Les candidatures en ligne sont en cours de préparation. Contactez support@vianexis.eu ou réessayez plus tard.",
      successTitle: "Candidature reçue",
      successBody: "Merci. Votre candidature est en cours d'examen. L'accès n'est pas accordé tant qu'un administrateur ViaNexis ne l'a pas approuvé.",
      newSubmission: "Nouvelle candidature",
      referenceLabel: "Référence de la demande",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Nous vous contacterons après examen. Conservez la référence de votre candidature pour obtenir de l'aide.",
      captchaHint: "Effectuez le contrôle de sécurité avant de soumettre.",
      supportContact: "Besoin d'aide ? Contactez {email}.",
      errors: {
        required: "Ce champ est obligatoire.",
        email: "Un e-mail est requis.",
        emailInvalid: "Entrez une adresse e-mail valide.",
        password: "Le mot de passe doit comporter au moins 8 caractères.",
        privacy: "L'acceptation de la confidentialité est requise.",
        submitFailed: "La candidature n'a pas pu être envoyée. Réessayez plus tard.",
        duplicate: "Une candidature pour cette entreprise ou email est déjà en cours.",
        duplicateWithRef: "Une demande pour cette entreprise ou cet e-mail est déjà en cours (référence : {reference}).",
        captchaRequired: "Effectuez le contrôle de sécurité pour continuer.",
        captchaInvalid: "Le contrôle de sécurité a expiré ou échoué. Essayer à nouveau.",
        spam: "Soumission bloquée.",
        network: "Erreur réseau. Vérifiez votre connexion et réessayez.",
      },
    },
    company: { title: "Candidature d'entreprise", subtitle: "Demandez l'accès à la plateforme d'entreprise ViaNexis.", companyName: "Nom de l'entreprise *", country: "Country *", vatNumber: "VAT / tax ID", contactName: "Nom du contact *", contactEmail: "E-mail de contact *", contactPhone: "Phone *", fleetSize: "Fleet size", moduleInterests: "Modules d'intérêt", moduleOptions: [{ value: "driver_app", label: "Driver app" },{ value: "dispatch_portal", label: "Portail d'expédition" },{ value: "documents", label: "Documents" },{ value: "fleet_workshop", label: "Flotte / atelier" },{ value: "pallet_packaging", label: "Palette / emballage" },{ value: "external_shipper_receiver", label: "Expéditeur/destinataire externe" }], notes: "Notes" },
    driver: { title: "Demande de pilote", subtitle: "Auto-inscription – en attente d’approbation avant la connexion.", fullName: "Full name *", email: "Email *", password: "Password *", phone: "Phone", country: "Country", companyNameHint: "Nom de l'entreprise (facultatif)", companyCode: "Invitation / code d'entreprise (facultatif)", licenseNotes: "Notes de licence / ADR / GKI (facultatif)" },
    partner: { title: "Intérêt du partenaire", subtitle: "Demande d'expéditeur, de destinataire, d'entrepôt ou de partenaire douanier.", companyName: "Nom de l'entreprise *", role: "Role *", roleOptions: [{ value: "shipper", label: "Shipper" },{ value: "receiver", label: "Receiver" },{ value: "warehouse", label: "Warehouse" },{ value: "customs_broker", label: "Courtier en douane" },{ value: "other_partner", label: "Autre partenaire" }], contactName: "Nom du contact *", email: "Email *", phone: "Phone", notes: "Notes" },
  },
  authorityEfti: {
    cards: [
      {
