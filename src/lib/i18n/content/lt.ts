...
export const contentLt: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "Šiuo metu „ViaNexis“ pasiekiama naudojant bandomąją programą su pasirinktais operatoriais ir vairuotojais.",
      "Prieiga suaktyvinama po individualaus aptarimo ir patvirtinimo.",
      "Nėra viešos programų parduotuvės atsisiuntimo.",
    ],
    disclaimer:
      "ViaNexis neteigia, kad sistema yra oficialiai priimta ar sertifikuota visose šalyse.",
  },
  ...
  home: {
    ...
    contact: {
      ...
      body: "Šiuo metu prieiga pasiekiama naudojant kontroliuojamą bandomąją programą. Aktyvinimas atliekamas po individualios peržiūros.",
  ...
  applicationForms: {
    common: {
      privacy: "Sutinku su privatumo politika ir sutinku su duomenų tvarkymu. *",
      submit: "Pateikti paraišką",
      submitting: "Submitting…",
      intakeDisabled: "Rengiamos internetinės paraiškos. Kreipkitės į support@vianexis.eu arba bandykite dar kartą vėliau.",
      successTitle: "Paraiška gauta",
      successBody: "Ačiū. Jūsų paraiška peržiūrima. Prieiga nesuteikiama, kol jos nepatvirtina ViaNexis administratorius.",
      newSubmission: "Nauja programa",
      referenceLabel: "Paraiškos nuoroda",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Po peržiūros susisieksime su jumis. Išsaugokite savo paraiškos nuorodą, kad gautumėte paramą.",
      captchaHint: "Prieš pateikdami užbaikite saugos patikrą.",
      supportContact: "Reikia pagalbos? Susisiekite {email}.",
      errors: {
        required: "Šis laukas yra privalomas.",
        email: "Būtinas el.",
        emailInvalid: "Įveskite galiojantį el. pašto adresą.",
        password: "Slaptažodį turi sudaryti bent 8 simboliai.",
        privacy: "Būtinas privatumo sutikimas.",
        submitFailed: "Paraiškos išsiųsti nepavyko. Vėliau bandykite dar kartą.",
        duplicate: "Jau vykdoma paraiška šiai įmonei arba el.",
        duplicateWithRef: "Jau vykdoma paraiška šiai įmonei arba el. paštu (nuoroda: {reference}).",
        captchaRequired: "Norėdami tęsti, užbaikite saugos patikrą.",
        captchaInvalid: "Saugos patikros galiojimo laikas baigėsi arba nepavyko. Bandykite dar kartą.",
        spam: "Pateikimas užblokuotas.",
