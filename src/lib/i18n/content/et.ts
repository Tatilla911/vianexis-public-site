...
export const contentEt: SiteContent = {
  ...
  applicationForms: {
    common: {
      privacy: "Nõustun privaatsuspoliitikaga ja nõustun andmete töötlemisega. *",
      submit: "Esitage taotlus",
      submitting: "Submitting…",
      intakeDisabled: "Online-taotlused on ettevalmistamisel. Võtke ühendust support@vianexis.eu või proovige hiljem uuesti.",
      successTitle: "Taotlus vastu võetud",
      successBody: "Aitäh. Teie taotlus on ülevaatamisel. Juurdepääsu ei anta enne, kui ViaNexise administraator on selle heaks kiitnud.",
      newSubmission: "Uus rakendus",
      referenceLabel: "Rakenduse viide",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Võtame teiega pärast ülevaatamist ühendust. Hoidke oma taotluse viide toetuse saamiseks alles.",
      captchaHint: "Enne esitamist täitke turvakontroll.",
      supportContact: "Vajad abi? Võtke ühendust {email}.",
      errors: {
        required: "See väli on kohustuslik.",
        email: "E-post on kohustuslik.",
        emailInvalid: "Sisestage kehtiv e-posti aadress.",
        password: "Parool peab koosnema vähemalt 8 tähemärgist.",
        privacy: "Nõutav on privaatsusega nõustumine.",
        submitFailed: "Taotlust ei saanud saata. Proovige hiljem uuesti.",
        duplicate: "Selle ettevõtte või meili taotlemine on juba pooleli.",
        duplicateWithRef: "Selle ettevõtte või e-posti jaoks on taotlus juba pooleli (viide: {reference}).",
        captchaRequired: "Jätkamiseks viige läbi turvakontroll.",
        captchaInvalid: "Turvakontroll aegus või ebaõnnestus. Proovi uuesti.",
        spam: "Esitamine blokeeritud.",
