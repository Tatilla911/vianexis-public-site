...
export const contentSl: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis je trenutno na voljo v pilotnem programu z izbranimi prevozniki in vozniki.",
      "Dostop se aktivira po individualnem pogovoru in odobritvi.",
      "Brez prenosa iz javne trgovine z aplikacijami.",
    ],
    disclaimer:
      "ViaNexis ne trdi, da je sistem uradno sprejet ali certificiran v vseh državah.",
  },
  ...
  home: {
    ...
    contact: {
      ...
      body: "Dostop je trenutno na voljo prek nadzorovanega pilotnega programa. Aktivacija sledi individualnemu pregledu.",
  ...
  applicationForms: {
    common: {
      privacy: "Strinjam se s politiko zasebnosti in soglašam z obdelavo podatkov. *",
      submit: "Oddajte prijavo",
      submitting: "Submitting…",
      intakeDisabled: "Spletne prijave so v pripravi. Pišite na support@vianexis.eu ali poskusite znova pozneje.",
      successTitle: "Prijava prejeta",
      successBody: "Hvala. Vaša prijava je v pregledu. Dostop ni odobren, dokler ga skrbnik ViaNexis ne odobri.",
      newSubmission: "Nova aplikacija",
      referenceLabel: "Referenca aplikacije",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Po pregledu vas bomo kontaktirali. Shranite svojo referenco aplikacije za podporo.",
      captchaHint: "Pred oddajo opravite varnostno preverjanje.",
      supportContact: "Potrebujete pomoč? Kontaktirajte {email}.",
      errors: {
        required: "To polje je obvezno.",
        email: "E-pošta je obvezna.",
        emailInvalid: "Vnesite veljaven e-poštni naslov.",
        password: "Geslo mora imeti vsaj 8 znakov.",
        privacy: "Potreben je sprejem zasebnosti.",
        submitFailed: "Prijave ni bilo mogoče poslati. Poskusite znova pozneje.",
        duplicate: "Prijava za to podjetje ali e-pošto je že v teku.",
        duplicateWithRef: "Prijava za to podjetje ali e-pošto je že v teku (referenca: {reference}).",
        captchaRequired: "Za nadaljevanje dokončajte varnostno preverjanje.",
        captchaInvalid: "Varnostno preverjanje je poteklo ali ni uspelo. poskusi ponovno",
        spam: "Oddaja je blokirana.",
        network: "Omrežna napaka. Preverite povezavo in poskusite znova.",
      },
    },
    company: { title: "Aplikacija podjetja", subtitle: "Prijavite se za dostop do platforme podjetja ViaNexis.", companyName: "Ime podjetja *", country: "Country *", vatNumber: "VAT / tax ID", contactName: "Ime kontakta *", contactEmail: "Kontaktni email *", contactPhone: "Phone *", fleetSize: "Fleet size", moduleInterests: "Zanimivi moduli", moduleOptions: [{ value: "driver_app", label: "Driver app" },{ value: "dispatch_portal", label: "Odpremni portal" },{ value: "documents", label: "Documents" },{ value: "fleet_workshop", label: "Vozni park / delavnica" },{ value: "pallet_packaging", label: "Paleta / embalaža" },{ value: "external_shipper_receiver", label: "Zunanji pošiljatelj/prejemnik" }], notes: "Notes" },
    driver: { title: "Aplikacija gonilnika", subtitle: "Samoregistracija — čaka na odobritev pred prijavo.", fullName: "Full name *", email: "Email *", password: "Password *", phone: "Phone", country: "Country", companyNameHint: "Ime podjetja (neobvezno)", companyCode: "Povabilo/šifra podjetja (neobvezno)", licenseNotes: "Opombe o licenci/ADR/GKI (neobvezno)" },
    partner: { title: "Partnerski interes", subtitle: "Poizvedba pošiljatelja, prejemnika, skladišča ali carinskega partnerja.", companyName: "Ime podjetja *", role: "Role *", roleOptions: [{ value: "shipper", label: "Shipper" },{ value: "receiver", label: "Receiver" },{ value: "warehouse", label: "Warehouse" },{ value: "customs_broker", label: "Carinski posrednik" },{ value: "other_partner", label: "Drugi partner" }], contactName: "Ime kontakta *", email: "Email *", phone: "Phone", notes: "Notes" },
  },
  authorityEfti: {
    cards: [
      {
