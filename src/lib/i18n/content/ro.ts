...
export const contentRo: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis este disponibil în prezent printr-un program pilot cu transportatori și șoferi selectați.",
      "Accesul este activat după discuție și aprobare individuală.",
      "Nicio descărcare publică din magazinul de aplicații.",
    ],
    disclaimer:
      "ViaNexis nu pretinde că sistemul este acceptat sau certificat oficial în fiecare țară.",
  },
  ...
  home: {
    ...
    contact: {
      ...
      body: "Accesul este disponibil în prezent printr-un program pilot controlat. Activarea urmează unei examinări individuale.",
  ...
  applicationForms: {
    common: {
      privacy: "Accept politica de confidențialitate și sunt de acord cu prelucrarea datelor. *",
      submit: "Trimiteți cererea",
      submitting: "Submitting…",
      intakeDisabled: "Se pregătesc aplicații online. Contactați support@vianexis.eu sau încercați din nou mai târziu.",
      successTitle: "Cerere primită",
      successBody: "Multumesc. Aplicația dvs. este în curs de examinare. Accesul nu este acordat până când un administrator ViaNexis nu îl aprobă.",
      newSubmission: "Aplicație nouă",
      referenceLabel: "Referința aplicației",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Vă vom contacta după examinare. Păstrați referința aplicației pentru asistență.",
      captchaHint: "Finalizați verificarea de securitate înainte de a trimite.",
      supportContact: "Ai nevoie de ajutor? Contactați {email}.",
      errors: {
        required: "Acest câmp este obligatoriu.",
        email: "E-mailul este obligatoriu.",
        emailInvalid: "Introduceți o adresă de e-mail validă.",
        password: "Parola trebuie să aibă cel puțin 8 caractere.",
        privacy: "Este necesară acceptarea confidențialității.",
        submitFailed: "Aplicația nu a putut fi trimisă. Încercați din nou mai târziu.",
        duplicate: "O cerere pentru această companie sau e-mail este deja în curs.",
        duplicateWithRef: "O cerere pentru această companie sau e-mail este deja în curs (referință: {reference}).",
        captchaRequired: "Finalizați verificarea de securitate pentru a continua.",
        captchaInvalid: "Verificarea de securitate a expirat sau a eșuat. Încearcă din nou.",
        spam: "Trimiterea a fost blocată.",
