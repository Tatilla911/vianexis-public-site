...
export const contentPt: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "O ViaNexis está atualmente disponível através de um programa piloto com transportadoras e motoristas selecionados.",
      "O acesso é ativado após discussão e aprovação individual.",
      "Nenhum download na loja de aplicativos pública.",
    ],
    disclaimer:
      "A ViaNexis não afirma que o sistema seja oficialmente aceito ou certificado em todos os países.",
  },
  ...
  home: {
    ...
    contact: {
      ...
      body: "O acesso está atualmente disponível através de um programa piloto controlado. A ativação segue uma análise individual.",
  ...
  applicationForms: {
    common: {
      privacy: "Aceito a política de privacidade e concordo com o processamento de dados. *",
      submit: "Enviar inscrição",
      submitting: "Submitting…",
      intakeDisabled: "As inscrições on-line estão sendo preparadas. Contate support@vianexis.eu ou tente novamente mais tarde.",
      successTitle: "Inscrição recebida",
      successBody: "Obrigado. Sua inscrição está em análise. O acesso não é concedido até que um administrador ViaNexis o aprove.",
      newSubmission: "Novo aplicativo",
      referenceLabel: "Referência do aplicativo",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Entraremos em contato com você após análise. Mantenha a referência do seu aplicativo para suporte.",
      captchaHint: "Conclua a verificação de segurança antes de enviar.",
      supportContact: "Precisa de ajuda? Contacte {email}.",
      errors: {
        required: "Este campo é obrigatório.",
        email: "O e-mail é obrigatório.",
        emailInvalid: "Insira um endereço de e-mail válido.",
        password: "A senha deve ter pelo menos 8 caracteres.",
        privacy: "A aceitação da privacidade é necessária.",
        submitFailed: "Não foi possível enviar a inscrição. Tente novamente mais tarde.",
        duplicate: "Uma inscrição para esta empresa ou e-mail já está em andamento.",
        duplicateWithRef: "Já existe um pedido em curso para esta empresa ou e-mail (referência: {reference}).",
        captchaRequired: "Conclua a verificação de segurança para continuar.",
        captchaInvalid: "A verificação de segurança expirou ou falhou. Tente novamente.",
        spam: "Envio bloqueado.",
        network: "Erro de rede. Verifique sua conexão e tente novamente.",
      },
    },
    company: { title: "Aplicativo da empresa", subtitle: "Inscreva-se para obter acesso à plataforma da empresa ViaNexis.", companyName: "Nome da empresa *", country: "Country *", vatNumber: "VAT / tax ID", contactName: "Nome do contato *", contactEmail: "E-mail de contato *", contactPhone: "Phone *", fleetSize: "Fleet size", moduleInterests: "Módulos de interesse", moduleOptions: [{ value: "driver_app", label: "Driver app" },{ value: "dispatch_portal", label: "Portal de expedição" },{ value: "documents", label: "Documents" },{ value: "fleet_workshop", label: "Frota / oficina" },{ value: "pallet_packaging", label: "Palete / embalagem" },{ value: "external_shipper_receiver", label: "Remetente/receptor externo" }], notes: "Notes" },
    driver: { title: "Aplicativo de driver", subtitle: "Autorregistro — aprovação pendente antes do login.", fullName: "Full name *", email: "Email *", password: "Password *", phone: "Phone", country: "Country", companyNameHint: "Nome da empresa (opcional)", companyCode: "Convite/código da empresa (opcional)", licenseNotes: "Notas de licença/ADR/GKI (opcional)" },
    partner: { title: "Interesse do parceiro", subtitle: "Consulta ao expedidor, destinatário, armazém ou parceiro aduaneiro.", companyName: "Nome da empresa *", role: "Role *", roleOptions: [{ value: "shipper", label: "Shipper" },{ value: "receiver", label: "Receiver" },{ value: "warehouse", label: "Warehouse" },{ value: "customs_broker", label: "Despachante aduaneiro" },{ value: "other_partner", label: "Outro parceiro" }], contactName: "Nome do contato *", email: "Email *", phone: "Phone", notes: "Notes" },
  },
  authorityEfti: {
    cards: [
      {
