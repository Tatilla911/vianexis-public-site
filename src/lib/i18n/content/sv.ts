...
export const contentSv: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis är för närvarande tillgängligt genom ett pilotprogram med utvalda operatörer och förare.",
      "Access aktiveras efter individuell diskussion och godkännande.",
      "Ingen offentlig app-butik nedladdning.",
    ],
    disclaimer:
      "ViaNexis hävdar inte att systemet är officiellt accepterat eller certifierat i alla länder.",
  },

  moduleLabels: {
    goal: "Mål",
    appFoundation: "Nyckelfunktioner",
  ...
  platformModules: [
    ...
    },
    {
      ...
      goal: "Flotta och resa översikt på karta — operativ orientering.",
  ...
  home: {
    ...
    contact: {
      ...
      body: "Tillgång är för närvarande tillgänglig genom ett kontrollerat pilotprogram. Aktivering sker efter en individuell granskning.",
  ...
  applicationForms: {
    common: {
      privacy: "Jag accepterar integritetspolicyn och samtycker till databehandling. *",
      submit: "Skicka in ansökan",
      submitting: "Submitting…",
      intakeDisabled: "Onlineansökningar förbereds. Kontakta support@vianexis.eu eller försök igen senare.",
      successTitle: "Ansökan inkommen",
      successBody: "Tack. Din ansökan är under granskning. Åtkomst beviljas inte förrän en ViaNexis-administratör godkänner det.",
      newSubmission: "Ny applikation",
      referenceLabel: "Ansökningsreferens",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Vi kommer att kontakta dig efter granskning. Spara din ansökan referens för support.",
      captchaHint: "Genomför säkerhetskontrollen innan du skickar in.",
      supportContact: "Behöver du hjälp? Kontakta {email}.",
      errors: {
        required: "Detta fält är obligatoriskt.",
        email: "E-post krävs.",
        emailInvalid: "Ange en giltig e-postadress.",
        password: "Lösenordet måste bestå av minst 8 tecken.",
        privacy: "Integritetsgodkännande krävs.",
        submitFailed: "Ansökan kunde inte skickas. Försök igen senare.",
        duplicate: "En ansökan för det här företaget eller e-postmeddelandet pågår redan.",
        duplicateWithRef: "En ansökan för detta företag eller e-post pågår redan (referens: {reference}).",
        captchaRequired: "Slutför säkerhetskontrollen för att fortsätta.",
        captchaInvalid: "Säkerhetskontrollen har löpt ut eller misslyckades. Försök igen.",
        spam: "Inlämning blockerad.",
