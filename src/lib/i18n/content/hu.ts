...
export const contentHu: SiteContent = {
  ...
  applicationForms: {
    common: {
      ...
      successBody: "Köszönjük. A jelentkezés ellenőrzés alatt van. Hozzáférés csak admin jóváhagyás után jár — ez nem automatikus jóváhagyás.",
      newSubmission: "Új jelentkezés",
      referenceLabel: "Jelentkezési azonosító",
      submittedAtLabel: "Beküldve",
      statusLabel: "Státusz",
      statusUnderReview: "Ellenőrzés alatt",
      nextStep: "A felülvizsgálat után felvesszük a kapcsolatot. Őrizd meg a jelentkezési azonosítót.",
      captchaHint: "A beküldés előtt teljesítsd a biztonsági ellenőrzést.",
      supportContact: "Segítség kell? Írj ide: {email}.",
      errors: {
        ...
        duplicate: "Ehhez a céghez vagy e-mail-címhez már tartozik folyamatban lévő jelentkezés.",
        duplicateWithRef: "Ehhez a céghez vagy e-mail-címhez már tartozik folyamatban lévő jelentkezés (azonosító: {reference}).",
        captchaRequired: "A folytatáshoz teljesítsd a biztonsági ellenőrzést.",
        captchaInvalid: "A biztonsági ellenőrzés lejárt vagy sikertelen. Próbáld újra.",
        spam: "A beküldés blokkolva.",
        network: "Hálózati hiba. Ellenőrizd a kapcsolatot, majd próbáld újra.",
      },
    },
    company: { title: "Cég jelentkezés", subtitle: "ViaNexis céges platform hozzáférés igénylése.", companyName: "Cég neve *", country: "Ország *", vatNumber: "Adószám / VAT", contactName: "Kapcsolattartó neve *", contactEmail: "Kapcsolattartó e-mail *", contactPhone: "Telefon *", fleetSize: "Flotta mérete", moduleInterests: "Érdeklődő modulok", moduleOptions: [{ value: "driver_app", label: "Sofőr app" },{ value: "dispatch_portal", label: "Diszpécser portál" },{ value: "documents", label: "Dokumentumkezelés" },{ value: "fleet_workshop", label: "Flotta / műhely" },{ value: "external_shipper_receiver", label: "Külső feladó / címzett" }], notes: "Megjegyzés" },
