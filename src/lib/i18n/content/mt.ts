...
export const contentMt: SiteContent = {
  ...
  hero: {
    ...
    items: [
      "ViaNexis bħalissa huwa disponibbli permezz ta’ programm pilota ma’ trasportaturi u sewwieqa magħżula.",
      "L-aċċess jiġi attivat wara diskussjoni u approvazzjoni individwali.",
      "L-ebda tniżżil pubbliku tal-app-store.",
    ],
    disclaimer:
      "ViaNexis ma jippretendix li s-sistema hija aċċettata jew iċċertifikata uffiċjalment f'kull pajjiż.",
  },
  ...
  home: {
    ...
    contact: {
      ...
      body: "L-aċċess bħalissa huwa disponibbli permezz ta' programm pilota kkontrollat. L-attivazzjoni ssegwi reviżjoni individwali.",
  ...
  applicationForms: {
    common: {
      privacy: "Naċċetta l-politika tal-privatezza u naċċetta l-ipproċessar tad-dejta. *",
      submit: "Issottometti applikazzjoni",
      submitting: "Submitting…",
      intakeDisabled: "Qed jitħejjew applikazzjonijiet onlajn. Ikkuntattja support@vianexis.eu jew erġa' pprova aktar tard.",
      successTitle: "Applikazzjoni riċevuta",
      successBody: "Grazzi. L-applikazzjoni tiegħek qed tiġi riveduta. L-aċċess ma jingħatax sakemm amministratur ta' ViaNexis japprovah.",
      newSubmission: "Applikazzjoni ġdida",
      referenceLabel: "Referenza tal-applikazzjoni",
      submittedAtLabel: "Submitted at",
      statusLabel: "Status",
      statusUnderReview: "Under review",
      nextStep: "Aħna se nikkuntattjawk wara reviżjoni. Żomm ir-referenza tal-applikazzjoni tiegħek għall-appoġġ.",
      captchaHint: "Imla l-kontroll tas-sigurtà qabel ma tissottometti.",
      supportContact: "Għandek bżonn għajnuna? Ikkuntattja {email}.",
      errors: {
        required: "Dan il-qasam huwa meħtieġ.",
        email: "L-email hija meħtieġa.",
        emailInvalid: "Daħħal indirizz elettroniku validu.",
        password: "Il-password għandu jkun ta' mill-inqas 8 karattri.",
        privacy: "L-aċċettazzjoni tal-privatezza hija meħtieġa.",
        submitFailed: "L-applikazzjoni ma setgħetx tintbagħat. Erġa' pprova aktar tard.",
        duplicate: "Applikazzjoni għal din il-kumpanija jew email diġà għaddejja.",
        duplicateWithRef: "Applikazzjoni għal din il-kumpanija jew email diġà għaddejja (referenza: {reference}).",
        captchaRequired: "Imla l-kontroll tas-sigurtà biex tkompli.",
        captchaInvalid: "Il-kontroll tas-sigurtà skada jew falla. Erġa' pprova.",
        spam: "Sottomissjoni imblukkata.",
