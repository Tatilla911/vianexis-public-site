...
const pages = [
  ...
  { path: "/hu/driver-app/privacy", expectStatus: 200 },
  { path: "/en/driver-app/privacy", expectStatus: 200 },
  { path: "/hu/driver-app/account-deletion", expectStatus: 200 },
  { path: "/en/driver-app/account-deletion", expectStatus: 200 },
  { path: "/hu/driver-app/data-safety", expectStatus: 200 },
  { path: "/en/driver-app/legal", expectStatus: 200 },
  { path: "/hu/privacy-request", expectStatus: 200 },
  { path: "/en/privacy-request", expectStatus: 200 },
